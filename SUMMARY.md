...
* [Ruuvi Network](communication/ruuvi-network/README.md)
  * [Backends](communication/ruuvi-network/backends/README.md)
    * [Ruuvi Network \(Serverless\)](communication/ruuvi-network/backends/amplify/README.md)
      * [User API](communication/ruuvi-network/backends/amplify/user-api.md)
      * [Gateway API](communication/ruuvi-network/backends/amplify/gateway-api.md)
