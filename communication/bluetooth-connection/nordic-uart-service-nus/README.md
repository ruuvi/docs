...
**Watchdog on RuuviTag**
In development versions of RuuviTag firmware there is 120 second delay from starting of the connection in which the central must complete the registration process. If the deadline is not met, tag assumes that there is a software lockup and reboots. In production versions this deadline is 12 seconds.&#x20;
...
**Getting started**
We have published [ruuvi.air.ble_nus](https://github.com/ruuvi/ruuvi.air.ble_nus) tool for developing GATT communication with RuuviTags and Ruuvi Air. This can be used for quickly trying out the 2-way communication before developing your own applcations. 